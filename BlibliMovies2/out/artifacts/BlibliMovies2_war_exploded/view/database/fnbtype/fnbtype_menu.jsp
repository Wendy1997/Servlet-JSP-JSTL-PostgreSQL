...
<div class="container-fluid" align="center">
    ...
    <!-- Close Button -->
    <a type="button" class="close" href="/admin/fnb">&times;</a>
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    for(var key in result){
                        ...
                        output += '<td><a href=/admin/fnbtype/edit?id=' + result[key].id + '>Edit</a></td>\n';

                        if(result[key].status){
                            output += '<td><a href=/admin/fnbtype/delete?id=' + result[key].id + '>Delete</a></td>\n';
                        } else {
                            output += '<td><a href=/admin/fnbtype/delete?id=' + result[key].id + '>Retrieve</a></td>\n';
                        }
                    }
